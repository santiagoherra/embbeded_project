...
int main(int argc, char *argv[]) {
  ...
  pipeline = gst_parse_launch(
    ...
    "nvinfer name=primary-infer config-file-path=/opt/nvidia/deepstream/deepstream-6.0/samples/configs/deepstream-app/config_infer_primary.txt unique-id=1 model-engine-file=/opt/nvidia/deepstream/deepstream-6.0/samples/models/Primary_Detector/resnet10.caffemodel_b1_gpu0_fp16.engine "
    ...
    "! queue ! nvinfer name=secondary-infer unique-id=2 process-mode=2 infer-on-gie-id=1 infer-on-class-ids=0: batch-size=16 model-engine-file=/opt/nvidia/deepstream/deepstream-6.0/samples/models/Secondary_CarMake/resnet18.caffemodel_b16_gpu0_fp16.engine "
	...
	// Rama 1: Transmisión por UDP a otra PC
